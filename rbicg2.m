function [x,xt,flag,i,resvec,resvec_tilde,U1,U1_tilde,C1,C1_tilde,C1_hat,C1_tilde_hat,U0,U0_tilde] = ... 
    rbicg2(A,b,c,tol,maxit,x0,x0_tilde,U,U_tilde,build_space,s,k_ideal,M1,M2)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if (~isempty(U))
    ...
    [U C U_tilde C_tilde k  M Sigma N] = orthogonalize(U, C, U_tilde, C_tilde);
...
%                     fprintf(1, 'Dual space residual for ritz vector computation = %14.4e \n', res_tilde_norm);
            ...
            % Normalize columns of C and C_tilde with c1*c1_tilde etc.
            [C1_hat C1_tilde_hat] = binormalize(C1, C1_tilde, k1);
